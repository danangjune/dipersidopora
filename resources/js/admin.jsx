...
const resources = {
    markets: {
        ...
        defaults: { name: '', category: 'Pasar Rakyat', address: '', image: '', latitude: '', longitude: '', sort_order: 0, is_active: true },
    },
    commodities: {
        ...
        defaults: { name: '', unit: 'kg', image: '', sort_order: 0, is_active: true },
    },
    pages: {
        ...
        defaults: { title: '', slug: '', group: 'Profil', eyebrow: '', image: '', excerpt: '', content: '', sort_order: 0, is_published: true },
    },
    downloads: {
        ...
        defaults: { title: '', category: 'renja', file_path: '', sort_order: 0, is_published: true },
    },
    'survey-settings': {
        ...
        defaults: { title: 'Survey Kepuasan Masyarakat', external_url: '', qr_image: '', description: '', is_active: true },
    },
};
...
const menus = [
    ...
    { key: 'survey-settings', label: 'Master Survey', href: '/admin/survey-settings' },
];
